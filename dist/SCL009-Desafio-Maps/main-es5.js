...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getMarkers = function () {
        ...
        this.mapService.getMarkers()
            .subscribe(function (markers) { return _this.list = markers; });
    };
    ...
    AppComponent.prototype.ngAfterViewInit = function () {
        ...
        var list = this.mapService.getMarkers();
        console.log(list);
        list.forEach(function (element) {
            ...
            item.forEach(function (e) {
                ...
                var arr = [coordinates.lng, coordinates.lat];
                console.log(arr);
                var name = e.Name;
...
module.exports = "/* .match-parent {\n    width: 800px;\n    height: 600px;\n}\n.marker{\n    background-image: url(https://i.ibb.co/ypyh2Rb/chinch.png);\n    background-size: cover;\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    cursor: pointer;\n} */\n#map {\n    position:absolute;\n    left:25%;\n    top:0;\n    bottom:0;\n    width: 75%;\n    }\n.map-overlay {\n    position: absolute;\n    width: 25%;\n    top: 0;\n    bottom: 0;\n    left: 0;\n    font: 12px/20px 'Helvetica Neue', Arial, Helvetica, sans-serif;\n    background-color: #fff;\n    max-height: 100%;\n    overflow: hidden;\n    }\n.map-overlay fieldset {\n    display: none;\n    background: #ddd;\n    border: none;\n    padding: 10px;\n    margin: 0;\n    }\n.map-overlay input {\n    display: block;\n    border: none;\n    width: 100%;\n    border-radius: 3px;\n    padding: 10px;\n    margin: 0;\n    }\n.map-overlay .listing {\n    overflow: auto;\n    max-height: 100%;\n    }\n.map-overlay .listing > * {\n    display: block;\n    padding: 5px 10px;\n    margin: 0;\n    }\n.map-overlay .listing a {\n    border-bottom: 1px solid rgba(0, 0, 0, 0.1);\n    color: #404;\n    text-decoration: none;\n    }\n.map-overlay .listing a:last-child {\n    border: none;\n    }\n.map-overlay .listing a:hover {\n    background: #f0f0f0;\n    }\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MapService = /** @class */ (function (_super) {
    ...
    return MapService;
}(_data_models_init_markers__WEBPACK_IMPORTED_MODULE_3__["default"]));
